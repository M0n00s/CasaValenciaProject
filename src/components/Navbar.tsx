...
export const Navbar = () => {
  ...
  return (
    <header className=" flex w-full items-center justify-between px-4 md:px-10 shadow-md h-[10vh]">
      ...
      <nav
        className={` bg-white  pl-8 shadow-md flex flex-col gap-10 fixed w-[80%] sm:max-w-[200px]  h-full top-[11vh] transition-all duration-300  md:static md:items-center  md:flex-row  md:justify-center md:shadow-none md:pl-0 flex-1  ${
